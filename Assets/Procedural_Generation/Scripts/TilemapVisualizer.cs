...
public class TilemapVisualizer : MonoBehaviour
{
    ...
    internal void PaintSingleCornerWall(Vector2Int position, string binaryType)
    {
        ...
        if (WallByteTypes.wallDiagonalCornerUpLeft.Contains(typeAsInt))
        {
    ...
    {
        var tilePosition = tilemap.WorldToCell((Vector3)(Vector3Int)position);
        tilemap.SetTile(tilePosition, tile);
    }

    public void AddColorToSingleFloorTile(Vector2Int position, Color color)
    {
        var tilePosition = floorTilemap.WorldToCell((Vector3)(Vector3Int)position);
